...
class Dataset(Dataset): 
    ...
    def __getitem__(self, idx):
        ...
        question = "<OPEN_VOCABULARY_DETECTION>" + example['description']
        ...
        answer = example['description'] + quantized_string
...
for epoch in range(epochs): 
    ...
    output_dir = f"./model_checkpoints_waveUi_description/epoch_{epoch+1}"
